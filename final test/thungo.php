  ...
  <body>
          ...
          <div class="row">
            ...
            <div class="col-md-6 ">
              <div class="search">
                ...
                <button type="button" class="btn btn-secondary" onclick="location.href = 'login-page.php'"> login</button>
    ...
    <!-- nav -->
     ...
     <div class="container">
      ...
      <h3>THƯ NGỎ</h3>
      <p>Thư ngỏ gửi tới các cô giáo, thầy giáo, các anh chị và các bạn đã đến với trang Web của Khoa Kinh tế và quản lý
        ...
        Đội ngũ cán bộ giảng viên hiện nay của Khoa
        ...
        Chúng tôi tin rằng trong thời gian tới Khoa tiếp tục là nơi đào tạo uy tín với những kỹ sư, nhà quản lý kinh doanh giỏi, là trung tâm tư vấn tin cậy cho các doanh nghiệp và các ngành kinh tế, góp phần đưa đất nước vững bước phát triển, tiến vào nền kinh tế tri thức và hội nhập quốc tế.
                                                                                ...
                                                                                TM. Ban Lãnh đạo Khoa Kinh tế và Quản lý - Trường Đại học Thủy lợi
