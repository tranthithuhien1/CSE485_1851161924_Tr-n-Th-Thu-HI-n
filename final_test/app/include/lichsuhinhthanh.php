...
<html lang="en">
  ...
  <body>
        <form action="/" method="post" enctype="multipart/form-data">
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-12 gthieu text-white" style="margin-bottom: 5%;">
                            <h5 >
                                <a href="gioithieu.php" class="text-white">Giới thiệu</a> > <a href="lichsuhinhthanh.php" class="text-white">Lịch sử hình thành</a> 
                            </h5>
                        </div>
                   </div>
            ...
            <div class="main">
                <div class="container">
                    <div class="row lichsuhinhthanh" style="margin-left:2%" >
                        <div class="col-md-9">
                            <h3>Lịch sử hình thành</h3>
                             <?php 
                                require("../../app/database/config.php");
                                $sql = "SELECT * FROM lichsuhinhthanh";
                 ...
                 <div class="row" style="float: right;margin-right: 20%;">
                        <div class="col-md-12" style="float: right;">
                            <a href="lichsuhinhthanh.php">Trở về đầu trang</a>
                        </div>
                    </div>
                    <div class="row icon" >
