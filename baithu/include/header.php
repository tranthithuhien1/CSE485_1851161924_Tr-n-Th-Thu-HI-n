        ...
        <div class="row text-white globalnav fixed-top" style="background-color: #003478; margin: 0px; float: right;">
                ...
                <div class=" list-top " style="display: flex;">
                    <ul style="display: flex;">
                        ...
                        <li>
                            Ngôn ngữ:
                           <a href="http://fem.tlu.edu.vn/#"><img src="http://fem.tlu.edu.vn/cse/assets/images/icons/icon-lang-vi.png" alt=""></a> 
                           <a href="http://fem.tlu.edu.vn/#"><img src="http://fem.tlu.edu.vn/cse/assets/images/icons/icon-lang-en.png" alt=""> </a> 
                        </li>
                    </ul>
                </div>
                <div class="search " >
                ...
                <div class="search-mobile">
                    ...
                    <div class="search-frame hide">
                        ...
                        <a href="http://fem.tlu.edu.vn/chi-tiet/s"class="hide"><i class="fa fa-search text-secondary" aria-hidden="true" style="cursor: pointer;"></i></a>
                    ...
                    <div class="title">
                       <nav class="navbar navbar-expand-sm navbar-light navbar1" style=" padding: 0px !important;" >
                           ...
                           <div class="collapse navbar-collapse" id="collapsibleNavId">
                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                    <li class="nav-item dropdown">
                                       <a class="navbar-brand has-sub has-sub1" href="../gioithieu/gioithieu.php" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                       GIỚI THIỆU</a>
                                       <div class="dropdown-menu nav-sub nav-sub1 dropdown_menu  " aria-labelledby="dropdownId">
                                           <a class="dropdown-item text-white" href="logokhoa.php">Logo khoa CNTT</a>
                                           <a class="dropdown-item text-white" href="loichaomung.php">Lời chào mừng</a>
                                           <a class="dropdown-item text-white" href="cocautochuc.php">Tổ chức</a>
                                           <a class="dropdown-item text-white" href="hoptacquocte.php">Hợp tác liên kết</a>
                                       </div>
                                   </li>
                               </ul>
                           </div>
